...
import frc.robot.commands.Gear.GearPanel;
import frc.robot.commands.Gear.GearPiston;
import frc.robot.commands.Gear.HopperPiston;
import frc.robot.commands.Gear.PushGear;
...
public class OI {
  ...
  public Joystick ojs = new Joystick(constants.oJSPort);
	public Joystick randJs = new Joystick(constants.randP);
